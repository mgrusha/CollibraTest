...
public class FilterResults extends BaseTest {

    @Test
    public void ExternalHardDrive() {
        GeneralFilterArea subCategory = getStartPage().clickOnKategorie().selectKategorie(Categories.KOMPUTER).clickOnComputer();
